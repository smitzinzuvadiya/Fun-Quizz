...
function ProtectedRoute({ children }) {
  const { hasClaimedBonus } = useCoins();
  if (!hasClaimedBonus) {
...
function AppContent() {
  ...
  // Hide bottom nav on Quiz, Result, and Welcome screens
  const showBottomNav = !location.pathname.startsWith('/quiz') && !location.pathname.startsWith('/result') && !location.pathname.startsWith('/welcome');
