...
export function LifelineFlipQuestionPopup({ isOpen, onClose, onUseFree, onUseCoins }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col justify-end">
      ...
      <div className="bg-white w-full rounded-t-[32px] pt-8 pb-10 px-6 relative flex flex-col animate-in slide-in-from-bottom duration-300">
        ...
        <h2 className="text-2xl font-black text-black text-center mt-10 mb-3 tracking-tight">Use Flip Question Lifeline</h2>
        
        <p className="text-center text-[#4B5563] font-medium text-[16px] leading-relaxed mb-8 px-4">
          The flip the question be paused for 30 seconds to allow more time to answer the question.
        </p>
